...
/* ── Sender variants ── */
.plm-mine  { background: #1c48e0; }
.plm-theirs { background: #ffffff; border: 1.5px solid #e5e7eb; }
...
.plm-mine  .plm-tag-plain { color: rgba(255,255,255,0.9); }
.plm-theirs .plm-tag-plain { color: #6b7280; }
...
.plm-mine  .plm-title { color: #fff; }
.plm-theirs .plm-title { color: #111827; }
...
.plm-mine  .plm-meta { color: rgba(255,255,255,0.75); }
.plm-theirs .plm-meta { color: #6b7280; }
...
.plm-mine  .plm-budget { color: #ffd59e; background: rgba(255,255,255,0.12); }
.plm-theirs .plm-budget { color: #ff5a1f; background: #fff3ee; }
...
.plm-mine  .plm-desc { color: rgba(255,255,255,0.8); }
.plm-theirs .plm-desc { color: #4b5563; }
...
.plm-mine .plm-cta:hover { background: rgba(255,255,255,0.28); }

.plm-theirs .plm-cta {
  background: #2254f5;
  color: #fff;
}
.plm-theirs .plm-cta:hover { background: #1a42d4; }

.plm-arrow { font-size: 14px; }
...
.plm-mine  .plm-time { color: #fff; }
.plm-theirs .plm-time { color: #6b7280; }
</style>