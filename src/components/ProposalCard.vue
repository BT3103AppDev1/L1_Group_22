...
.proposal-card:hover { box-shadow: 0 6px 20px rgba(0,0,0,0.07); }
...
.pc-profile-btn:hover { border-color: #2254f5; color: #2254f5; }
...
.pc-message-btn:hover { background: #1a42d4; }
...
.pc-decline-btn:hover { background: #fef2f2; }
</style>