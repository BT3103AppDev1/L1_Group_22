...
<style scoped>
  ...
  .pm-mine .pm-status-chip   { 
    background: rgba(255,255,255,0.18); color: #fff; 
  }
  .pm-theirs .pm-status-chip { 
  ...
  .pm-mine .pm-contractor   { 
    color: #fff; 
  }
  .pm-theirs .pm-contractor { 
    color: #111827; 
  }
  ...
  .pm-mine .pm-details-row   { 
    background: rgba(255,255,255,0.12); 
  }
  .pm-theirs .pm-details-row { 
  ...
  .pm-mine .pm-detail-label { 
    color: rgba(255,255,255,0.6); 
  }
  .pm-theirs .pm-detail-label { 
    color: #9ca3af; 
  }
  ...
  .pm-mine .pm-detail-value { 
    color: #fff; 
  }
  .pm-theirs .pm-detail-value { 
    color: #111827; 
  }
  ...
  .pm-mine .pm-cover-label   { 
    color: rgba(255,255,255,0.7); 
  }
  .pm-theirs .pm-cover-label { 
    color: #374151; 
  }
  ...
  .pm-mine .pm-cover-text   { 
    color: rgba(255,255,255,0.82); 
  }
  .pm-theirs .pm-cover-text { 
    color: #4b5563; 
  }
