    ...
    <section class="profile-card">
      <template v-if="!editing">
        <div class="profile-top">
          ...
          <!-- Edit Profile button - if this is the contractor viewing their own profile -->
        ...
        <div class="edit-layout">
          ...
          <div class="edit-main">
            ...
            <div class="skill-editor">
              ...
              <!-- All selected skills are removeable -->
    ...
    <section class="content-card">
      ...
      <div class="tab-content">
        <div v-if="activeTab === 'portfolio'">
          <PortfolioTab v-if="profileUid" :contractorId="profileUid" @project-added="loadProjectStats"/>
        </div>
        ...
        <div v-if="activeTab === 'reviews'">
          <ReviewsTab v-if="profileUid" :contractorId="profileUid" />
        </div>
      </div>
    </section>
  </div>
...
<script setup>
  ...
  // Check if profile page viewer is owner or another user
  const profileUid = ref(route.params.contractorId || "")
  ...
  // Load project tracker dashboard 
